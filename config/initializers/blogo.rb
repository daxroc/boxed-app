Blogo.configure do |config|
  ...
  config.site_title    = 'Sixth IO'
  config.site_subtitle = 'The incoherent and misguided adventures of a cloud engineer...'
  ...
  #
  config.github_username  = 'daxroc'
  config.twitter_username = 'daxroc'
end
